...
| 19 | [Domain 仓储协议与落地实现漂移](19-domain-repository-ports-vs-concrete-executors.md) | `consistency`, `observability` | **resolved**：细粒度 Store/Remote + AppServices Port 组装 + Fake 主路径（0051–0053）。 |
