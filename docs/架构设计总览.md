...
> 高负载验证计划：[`高负载IM验证计划.md`](./高负载IM验证计划.md)（issues `0029`–`0033`） · 实践手册：[`load-practice/`](./load-practice/) · iOS 抗压：[`ios-high-load-client.md`](./ios-high-load-client.md)  
...
| 高负载验证 | 实践手册、压测硬化、发送背压、iOS 抗压方案 | 0029–0033 | open（见 [`高负载IM验证计划.md`](./高负载IM验证计划.md)） |
