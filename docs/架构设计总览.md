...
> 高负载验证计划：[`高负载IM验证计划.md`](./高负载IM验证计划.md)（issues `0029`–`0034` complete） · **方法论**：[`验证链路设计方法论.md`](./验证链路设计方法论.md) · 实践手册：[`load-practice/`](./load-practice/) · iOS 抗压：[`ios-high-load-client.md`](./ios-high-load-client.md)  
...
| iOS 正确性 | OTP 登录 → 本地优先 → sync → WS（媒体/推送后置） | 0022–0028 | open |
