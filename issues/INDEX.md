...
| [0030](0030-load-practice-playbook.md) | 高负载业界实践模拟手册（load-practice） | open | `ready-for-agent`, `p0` | 2026-07-26 |
| [0031](0031-harden-load-test-chaos.md) | 压测与混沌演练硬化：stub、基线数字、chaos 04 注入 | open | `ready-for-agent`, `p0` | 2026-07-26 |
| [0032](0032-send-side-outbox-backpressure.md) | 发送侧背压：outbox pending 超阈返回 429 | open | `ready-for-agent`, `p0`, `blocked-by:0031` | 2026-07-26 |
| [0033](0033-ios-high-load-client-design.md) | iOS 高负载/弱网客户端方案与坑点（文档先行） | open | `ready-for-agent`, `p0` | 2026-07-26 |
