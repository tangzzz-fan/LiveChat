...
│                       # M2 追加: group_500.yaml (006) / presence_mixed.yaml (007)
│                       # M3 追加: multi_device.yaml (010: 每用户 2~3 虚拟设备,
│                       #          断言 inbox 写入量不随设备数放大、路由集合正确)
│                       # M4 追加: ai_streaming.yaml (013: 50 并发生成 × 慢客户端
│                       #          混布, 断言帧分级调度: chunk 可丢、消息帧不丢)
